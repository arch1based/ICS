...
1. Κατεβάστε το αρχείο **`CP737_Converter.exe`** από τον σύνδεσμο που σας έδωσε το Τεχνικό Τμήμα ICS
...
2. Αντιγράψτε (ή φτιάξτε shortcut του) `CP737_Converter.exe` στον φάκελο που άνοιξε
...
Για βοήθεια επικοινωνήστε με το **Τεχνικό Τμήμα ICS**.
