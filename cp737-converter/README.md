...
### Βήμα 4 — Αυτόματη εκκίνηση με τα Windows (προαιρετικό)

Τσεκάρετε το **☑ Εκκίνηση αυτόματα με τα Windows** για να ξεκινά το πρόγραμμα μόνο του κάθε φορά που ανοίγει ο υπολογιστής — χωρίς να χρειαστεί να κάνετε τίποτα άλλο.
